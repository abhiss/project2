...
function default_1(app) {
    ...
    app.post("/user", function (req, res) {
        models_1.User.findOne({ where: { username: req.body.username } }).then(function (user) {
            console.log(user);
            if (user) {
                ...
                var newUser_1 = new models_1.User({
    ...
    app.post("/signin", function (req, res) {
        ...
        models_1.User.findOne({ where: { username: username } }).then(function (user) {
            if (!user) {
                var errors = void 0;
